...
--
-- Host: 127.0.0.1
-- Generation Time: Jul 26, 2022 at 01:26 PM
...
INSERT INTO `wilayah_kabupaten` (`id`, `id_provinsi`, `nama`) VALUES
...
INSERT INTO `wilayah_kecamatan` (`id`, `id_kabupaten`, `nama`) VALUES
...
--
ALTER TABLE `berobat`
  MODIFY `id_berobat` int(16) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=228;
COMMIT;
